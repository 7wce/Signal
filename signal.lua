...
local EventHandlerUtils = loadstring(game:HttpGet("https://raw.githubusercontent.com/Quenty/NevermoreEngine/refs/heads/main/src/signal/src/Shared/EventHandlerUtils.lua"))()
